      ...
      <section class="pt-32 pb-24">
        <div class="container mx-auto px-6">
          <div class="text-center mb-16">
            <h1 class="text-4xl font-light mb-4">Manuais e Procedimentos de Operação e de Manutenção</h1>
            <p class="text-lg text-muted-foreground font-light max-w-3xl mx-auto">
              Elaboração de manuais técnicos e procedimentos operacionais para garantir a correta operação e manutenção de sistemas e equipamentos.
            </p>
          </div>
          ...
          <div class="mb-24">
            <div class="relative h-[500px] rounded-2xl border overflow-hidden mb-12">
              <img
                src="/manuais/manuais.webp"
                alt="Manuais e Procedimentos de Operação e Manutenção - Enprodes"
          ...
          <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-24">
            ...
            <div class="group p-6 rounded-2xl border-2 border-gray-200 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:scale-105 hover:-translate-y-2 hover:border-enprodes-blue/50 relative overflow-hidden">
              ...
              <div class="relative z-10">
                <div class="relative h-48 mb-4 overflow-hidden bg-muted/20 rounded-xl">
                  <img
                    src="/manuais/aaa2.svg"
                    alt="Manuais de Manutenção"
                    class="absolute inset-8 h-[calc(100%-4rem)] w-[calc(100%-4rem)] object-contain"
                    loading="lazy"
                  />
                </div>
            ...
            <div class="group p-6 rounded-2xl border-2 border-gray-200 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:scale-105 hover:-translate-y-2 hover:border-enprodes-blue/50 relative overflow-hidden">
              ...
              <div class="relative z-10">
                <div class="relative h-48 mb-4 overflow-hidden bg-muted/20 rounded-xl">
                  <img
                    src="/manuais/aaa3.svg"
                    alt="Procedimentos Operacionais"
                    class="absolute inset-8 h-[calc(100%-4rem)] w-[calc(100%-4rem)] object-contain"
                    loading="lazy"
                  />
                </div>
            ...
            <div class="group p-6 rounded-2xl border-2 border-gray-200 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:scale-105 hover:-translate-y-2 hover:border-enprodes-blue/50 relative overflow-hidden">
              ...
              <div class="relative z-10">
                <div class="relative h-48 mb-4 overflow-hidden bg-muted/20 rounded-xl">
                  <img
                    src="/manuais/aaa4.svg"
                    alt="Procedimentos de Manutenção"
                    class="absolute inset-8 h-[calc(100%-4rem)] w-[calc(100%-4rem)] object-contain"
                    loading="lazy"
                  />
                </div>
            ...
            <div class="group p-6 rounded-2xl border-2 border-gray-200 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:scale-105 hover:-translate-y-2 hover:border-enprodes-blue/50 relative overflow-hidden">
              ...
              <div class="relative z-10">
                <div class="relative h-48 mb-4 overflow-hidden bg-muted/20 rounded-xl">
                  <img
                    src="/manuais/aaa5.svg"
                    alt="Diagramas e Fluxogramas"
                    class="absolute inset-8 h-[calc(100%-4rem)] w-[calc(100%-4rem)] object-contain"
                    loading="lazy"
                  />
                </div>
            ...
            <div class="group p-6 rounded-2xl border-2 border-gray-200 bg-white shadow-[0_4px_20px_rgba(0,0,0,0.08)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(0,0,0,0.15)] hover:scale-105 hover:-translate-y-2 hover:border-enprodes-blue/50 relative overflow-hidden">
              ...
              <div class="relative z-10">
                <div class="relative h-48 mb-4 overflow-hidden bg-muted/20 rounded-xl">
                  <img
                    src="/manuais/aaa6.svg"
                    alt="As-Built e Documentação Final"
                    class="absolute inset-8 h-[calc(100%-4rem)] w-[calc(100%-4rem)] object-contain"
                    loading="lazy"
                  />
                </div>
...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Elaboração de manuais técnicos e procedimentos operacionais: manuais de operação, manutenção, procedimentos padronizados e documentação as-built.'
    }
  ]
})
</script>
